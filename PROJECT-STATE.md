...
- [ ] 초기 콘텐츠: 품종 허브 1호 발행 완료 → 스포크 2~3편 — 초반은 질 우선
  ...
  - **보더콜리 색상 종류 스포크 발행(2026-09-10, 라이브)** — 모색 8종(검흰·블루머르·레드머르·초콜릿·라일락·삼색·브린들·세이블)+표지, 실사 스타일 AI 이미지 9장(전 장 검수 통과). 더블머르 경고(AKC, 자견당 25%·청각·시각 이상)·시세표(허브와 동일 기준) 포함. 비용 장당 약 510원 × 9장 ≈ 4,600원
