...
- [ ] 초기 콘텐츠: 품종 허브 1호 발행 완료 → 스포크 2~3편 — 초반은 질 우선
  ...
  - **보더콜리 운동량 스포크 작성 완료(2026-09-10, draft — 발행 대기)** — '극악의 난이도' 미디어 통념 검증 각도(사용자 제안). AKC(성견 30~90분+두뇌 자극 보완)·PetMD(부족 신호)·미네소타대 수의대(BCC) 출처, 딱지 하루 루틴 실례 포함. 표지 이미지 생성·검수 통과(커밋 `2338a2f`, 누적 12장 합계 약 1,200원)
