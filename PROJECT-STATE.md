...
- [x] 초기 콘텐츠 1호 품종(허브+스포크 2편) — 2026-09-10 기준 발행 3편, 스포크 추가 계속
  ...
  - **일상 글 '3D프린터 딱지 가면' 작성 완료(2026-09-10, draft — 발행 대기)** — 사용자 제공 본인 사진 3장(가면 거부→뻘쭘한 착용→클로즈업). 3000×4000 원본을 1600px로 리사이즈(품질 80, EXIF 제거), 표지는 클로즈업 얼굴 띠 16:9 직접 크롭. `/daily/ddakji-3d-printed-mask/`. E-E-A-T용 일상·경험 축
