...
- [ ] 초기 콘텐츠: 품종 허브 1호 + 스포크 2~3편 — 초반은 질 우선
  - **보더콜리 허브 원고 완료(2026-09-10, draft)** — 운영자 반려견 '딱지'가 보더콜리로 확정됨. 원 출처 리서치(AKC·유전검사 자료·분양 시세) 기반, 한국 실정 축(시세·아파트·여름)과 색상 축 반영. '운영자는 이렇게 키웁니다' 섹션 반영 완료(2026-09-10 — 검흰, 혼자 산책 쓸쓸해서 데려옴, 아파트·하루 2~3회 산책, 고양이 괴롭히기·냉장고 정리 돕기, 흥분 잘함). 사용자 발행 확인 후 `draft: false`
